...
const About = () => {
  return (
    <section id="about" >
        ...
        <div id="about-text">
            <h2 className="h2">I'm a full stack developer with a passion for writing clean, elegant, and thoughtful code.</h2>
            <p>I have gradueted from a Bootcamp through General Assembly where I learned how to code using HTML, CSS, JavaScript, React, Express, EJS, Mongoose, and Python. Before this, I did about 6 months of self-study, including Codecademy's HTML, CSS, JavaScript, Intermediate JavaScript, and React courses. I definitely went down some deep Youtube rabbit holes getting excited about React and all things front-end! As you can imagine, I am learning something new everyday and am excited to continue this journey. </p>
